...
namespace backend.services.Controllers.Maestros
{
    ...
    public class UbigeoController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<ApiResponse<SqlRspDTO>>> postInsUbigeo([FromBody] UbigeoDTO ubigeo)
        {
            ApiResponse<SqlRspDTO> response = new ApiResponse<SqlRspDTO>();

            try
            {
                var result = await service.InsUbigeo(ubigeo);
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<ApiResponse<SqlRspDTO>>> postUpdUbigeo([FromBody] UbigeoDTO ubigeo)
        {
            ApiResponse<SqlRspDTO> response = new ApiResponse<SqlRspDTO>();

            try
            {
                var result = await service.UpdUbigeo(ubigeo);
