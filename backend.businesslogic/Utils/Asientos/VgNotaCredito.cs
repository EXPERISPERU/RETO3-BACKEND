...
{
    public class VgNotaCredito
    {
        CultureInfo ci_PE = new CultureInfo("es-PE");
        public VgNotaCredito() { }

        public string Debe(VisitaGuiadaNcDTO asiento, int indice)
        {
        ...
        public string Igv(VisitaGuiadaNcDTO asiento, int indice)
        {
        ...
        public string Haber(VisitaGuiadaNcDTO asiento, int indice)
        {
